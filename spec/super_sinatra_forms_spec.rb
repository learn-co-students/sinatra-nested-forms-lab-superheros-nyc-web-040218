describe App do
  ...
  describe 'POST /teams' do
    it 'submits the form' do
      ...
      fill_in("hero1_name", :with => "Amanda")
      fill_in("hero1_power", :with => "Ruby")
      fill_in("hero1_bio", :with => "I love Ruby!")
      fill_in("hero2_name", :with => "Arel")
      fill_in("hero2_power", :with => "JavaScript")
      fill_in("hero2_bio", :with => "I love JavaScript!")
      fill_in("hero3_name", :with => "Katie")
      fill_in("hero3_power", :with => "Sinatra")
      fill_in("hero3_bio", :with => "I love Sinatra!")
      click_button 'submit'
